        ...
        <div class="col-md-8">
            <div class="answer_info_bar" style="margin-top: 30px;">
                ...
                <div class="btn-group btn-group-sm pull-right" role="group" aria-label="...">
                    <button type="button" class="btn btn-default active">默认排序</button>
                    <button type="button" class="btn btn-default">
                        <a style="color: #666;text-decoration: none;" href="?sort=created">时间排序</a>
                    </button>
                </div>
            </div>
            <hr>

            @foreach($question->answers->sortByDesc('votes_count') as $answer)
                <div class="row">
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-2">
