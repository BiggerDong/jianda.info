        ...
        <div class="row">
            ...
            <div class="col-md-8" style="">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li role="presentation" class="active"><a href="/users/{{ $user->id }}/followq">关注的问题({{ $user->follow_questions_count }})</a></li>
                ...
                <div class="questions-user-home" style="margin-top: 50px;">
                    @foreach($info[0]->follows->sortByDesc('created_at') as $question)
                        <div class="row">
                            <div class="col-md-5">
                                <div class="row">
                                    <div class="col-md-2">
